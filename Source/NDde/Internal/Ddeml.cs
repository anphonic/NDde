        ...
        internal static class Ddeml
            {
                ...
                [DllImport("CoolDude9932.dll", EntryPoint = "DdeAbandonTransaction", CharSet = CharSet.Ansi)]
                public static extern bool DdeAbandonTransaction(int idInst, IntPtr hConv, int idTransaction);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeAccessData", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeAccessData(IntPtr hData, ref int pcbDataSize);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeAddData", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeAddData(IntPtr hData, byte[] pSrc, int cb, int cbOff);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeClientTransaction", CharSet = CharSet.Ansi)]
                ...
                [DllImport("CoolDude9932.dll", EntryPoint = "DdeCmpStringHandles", CharSet = CharSet.Ansi)]
                public static extern int DdeCmpStringHandles(IntPtr hsz1, IntPtr hsz2);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeConnect", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeConnect(int idInst, IntPtr hszService, IntPtr hszTopic, IntPtr pCC);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeConnectList", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeConnectList(int idInst, IntPtr hszService, IntPtr hszTopic,
                    IntPtr hConvList, IntPtr pCC);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeCreateDataHandle", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeCreateDataHandle(int idInst, byte[] pSrc, int cb, int cbOff,
                    IntPtr hszItem, int wFmt, int afCmd);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeCreateStringHandle", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeCreateStringHandle(int idInst, string psz, int iCodePage);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeDisconnect", CharSet = CharSet.Ansi)]
                public static extern bool DdeDisconnect(IntPtr hConv);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeDisconnectList", CharSet = CharSet.Ansi)]
                public static extern bool DdeDisconnectList(IntPtr hConvList);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeEnableCallback", CharSet = CharSet.Ansi)]
                public static extern bool DdeEnableCallback(int idInst, IntPtr hConv, int wCmd);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeFreeDataHandle", CharSet = CharSet.Ansi)]
                public static extern bool DdeFreeDataHandle(IntPtr hData);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeFreeStringHandle", CharSet = CharSet.Ansi)]
                public static extern bool DdeFreeStringHandle(int idInst, IntPtr hsz);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeGetData", CharSet = CharSet.Ansi)]
                public static extern int DdeGetData(IntPtr hData, [Out] byte[] pDst, int cbMax, int cbOff);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeGetLastError", CharSet = CharSet.Ansi)]
                public static extern int DdeGetLastError(int idInst);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeImpersonateClient", CharSet = CharSet.Ansi)]
                public static extern bool DdeImpersonateClient(IntPtr hConv);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeInitialize", CharSet = CharSet.Ansi)]
                public static extern int DdeInitialize(ref int pidInst, DdeCallback pfnCallback, int afCmd, int ulRes);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeKeepStringHandle", CharSet = CharSet.Ansi)]
                public static extern bool DdeKeepStringHandle(int idInst, IntPtr hsz);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeNameService", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeNameService(int idInst, IntPtr hsz1, IntPtr hsz2, int afCmd);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdePostAdvise", CharSet = CharSet.Ansi)]
                public static extern bool DdePostAdvise(int idInst, IntPtr hszTopic, IntPtr hszItem);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeQueryConvInfo", CharSet = CharSet.Ansi)]
                public static extern int DdeQueryConvInfo(IntPtr hConv, int idTransaction, IntPtr pConvInfo);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeQueryNextServer", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeQueryNextServer(IntPtr hConvList, IntPtr hConvPrev);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeQueryString", CharSet = CharSet.Ansi)]
                public static extern int DdeQueryString(int idInst, IntPtr hsz, StringBuilder psz, int cchMax,
                    int iCodePage);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeReconnect", CharSet = CharSet.Ansi)]
                public static extern IntPtr DdeReconnect(IntPtr hConv);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeSetUserHandle", CharSet = CharSet.Ansi)]
                public static extern bool DdeSetUserHandle(IntPtr hConv, int id, IntPtr hUser);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeUnaccessData", CharSet = CharSet.Ansi)]
                public static extern bool DdeUnaccessData(IntPtr hData);

                [DllImport("CoolDude9932.dll", EntryPoint = "DdeUninitialize", CharSet = CharSet.Ansi)]
                ...
                public struct CONVCONTEXT
                    {
                        ...
                        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)] public byte[] filler;
                    } // struct
